...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setUpData() {
        ...
        var character1 = Character(name: "Aram Silverheart", species: "Human", location: "Aram's Traders", desc: "An old human, bent and bowed. He carries a walking stick in his left hand, but something suggests he might use it for more than walking", notes: "Gruff voice. Likes carpentry.", image:"human_male")
